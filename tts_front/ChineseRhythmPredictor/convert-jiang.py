...
if __name__ =="__main__":
    ...
    toProsody(inFile="./data/raw/test.txt",outFile="./data/corpus/prosody_test.txt")
    toProsody(inFile="./data/raw/data_haitian_all_jieba.txt", outFile="./data/corpus/prosody_train.txt")
    toProsody(inFile="./data/raw/val.txt", outFile="./data/corpus/prosody_valid.txt")
    # toProsody(inFile='./data/raw/data_haitian_jieba.txt',outFile="./data/corpus/prosody_train.txt")
    ...
    toPos(inFile_train="./data/raw/data_haitian_all_jieba.txt",
            inFile_valid="./data/raw/val.txt",
            inFile_test="./data/raw/test.txt"
    )

    print("[4]->generate length files")
    toWordLength(inFile_train="./data/raw/data_haitian_all_jieba.txt",
            inFile_valid="./data/raw/val.txt",
            inFile_test="./data/raw/test.txt"
     )

    print("[5]->generate accmulate files")
    toWordAccum(inFile_train="./data/raw/data_haitian_all_jieba.txt",
                inFile_valid="./data/raw/val.txt",
                inFile_test="./data/raw/test.txt"
            )

    print("[6]->generate accmulate reverse files")
    toWordAccumReverse(inFile_train="./data/raw/data_haitian_all_jieba.txt",
                       inFile_valid="./data/raw/val.txt",
                       inFile_test="./data/raw/test.txt"
                    )

    print("[7]->generate position files")
    toWordPosition(inFile_train="./data/raw/data_haitian_all_jieba.txt",
                   inFile_valid="./data/raw/val.txt",
                   inFile_test="./data/raw/test.txt"
                )

...
#learning rate
LEARNING_RATE=0.003#0.01#0.003                      #学习率
DECAY=0.2#0.85#0.2                               #衰减系数
...
POS_NUM=37                              #词性信息数量
LENGTH_NUM=8                            #长度信息数量
MAX_SENTENCE_SIZE=60#40#28                    #固定句子长度为28 (从整个数据集得来)
TIMESTEP_SIZE=MAX_SENTENCE_SIZE         #LSTM的time_step应该和句子长度一致
WORD_VOCAB_SIZE=4145#393256                   # 样本中不同字的个数+1(padding 0)，根据处理数据的时候得到
